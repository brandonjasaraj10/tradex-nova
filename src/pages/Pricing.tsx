...
const TIERS: Tier[] = [
  {
    name: 'Starter',
    price: '$29.99',
    who: 'One account, and you want it to write itself up.',
    lines: [
      { text: '1 connected account', included: true },
      { text: 'Closed trades arrive once a day', included: true },
      { text: 'Unlimited manual and CSV accounts', included: true },
      { text: '25 Nova questions a day', included: true },
      { text: 'Live sync as trades close', included: false },
    ],
  ...
  },
  {
    name: 'Pro',
    price: '$59.99',
    who: 'You run a few accounts and want them current, not yesterday.',
    lines: [
      { text: '3 connected accounts', included: true },
      { text: 'Close a trade, it is journalled minutes later', included: true },
      { text: 'Unlimited manual and CSV accounts', included: true },
      { text: '100 Nova questions a day', included: true },
      { text: 'Extra accounts at $15/month', included: true },
    ],
    cta: 'Start journaling',
    featured: true,
  },
  {
    name: 'Elite',
    price: '$149.99',
    who: 'Several funded accounts at once, and downtime costs you money.',
    lines: [
      { text: '6 connected accounts', included: true },
      { text: 'Close a trade, it is journalled minutes later', included: true },
      { text: '300 Nova questions a day', included: true },
      { text: 'New platforms the week they ship', included: true },
      { text: 'Support answered first', included: true },
    ],
    cta: 'Start journaling',
  },
];
