      ...
      <motion.div initial="hidden" animate="visible" variants={{ visible: { transition: { staggerChildren: 0.1 } } }}>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-4 lg:gap-6 mb-6">
          <motion.div variants={fadeInUp} className="lg:col-span-4">
            ...
            {/*
              The plan lives beside the journal, not below it.
            
              It was a full-width row several screens down, so the confluences you
              are meant to be ticking against what you wrote were off screen the
              whole time you were writing. In this column it sits level with the
              editor and gives Main Content its full width back.
            */}
            <Card variant="default" className="p-4 mt-4">
                <div>
