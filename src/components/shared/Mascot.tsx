...
const POSES = {
  ...
  wave:    { src: mascotWave,    scale: 0.904 },  /* head 62.2% */
  present: { src: mascotPresent, scale: 1.078 },  /* head 52.2% */
  arms:    { src: mascotArms,    scale: 1.192 },  /* head 47.2% */
  lean:    { src: mascotLean,    scale: 1.210 },  /* head 46.5% */
  /*
  ...
  */
  ...
  /*
    Seated, legs hanging. For perching him on top of something - the edge of
    a card, a row of avatars - where a standing pose would have to float.
  */
  sitting: { src: mascotSitting, scale: 0.924 },  /* head 55.5% */
  /*
